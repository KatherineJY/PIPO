...
class InvestIntroduction extends Component {
    ...
    render() {
        return (
            <div className="component-holder banner-container  issuetHome">
                <div className="issue-start-container">
                    <h1>Customize my portfolio,<br />Get competitive return.</h1>
                    <Button className='to-register' ><Link  onClick={this.visitControl} to={{
                        pathname: 'issue/issueMain',
                    }}>Start Issuing<Icon type="right" /></Link></Button>
                </div>
            </div>
        );
    }
